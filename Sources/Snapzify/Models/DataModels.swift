...
enum ChineseScript: String, Codable, CaseIterable {
    case simplified
    case traditional
}
...
enum SentenceStatus: Codable, Equatable {
    case pending
    case ocrOnly
    case translated
    case error(String)
...
struct Document: Identifiable, Codable {
    ...
    init(id: UUID = UUID(), createdAt: Date = Date(), source: DocumentSource, script: ChineseScript = .simplified, sentences: [Sentence] = [], imageData: Data? = nil, isPinned: Bool = false, isSaved: Bool = false) {
        self.id = id
...
struct Sentence: Identifiable, Codable {
    ...
    init(id: UUID = UUID(), text: String, rangeInImage: CGRect? = nil, tokens: [Token] = [], pinyin: [String] = [], english: String? = nil, plecoURL: URL? = nil, audioAsset: AudioAsset? = nil, status: SentenceStatus = .pending, isPinned: Bool = false, isSaved: Bool = false) {
        self.id = id
        self.text = text
