    ...
    private var actionButtons: some View {
        HStack(spacing: T.S.sm) {
            ...
            Button {
                ...
                Label("Open in Pleco", systemImage: "book")
                    .font(.caption)
            }
            .buttonStyle(ActionButtonStyle())
            ...
            Button {
                ...
                Image(systemName: vm.sentence.isPinned ? "pin.fill" : "pin")
                    .font(.caption)
            }
            .buttonStyle(ActionButtonStyle(isActive: vm.sentence.isPinned))
            
            Button {
                vm.toggleSave()
            } label: {
                Image(systemName: vm.sentence.isSaved ? "bookmark.fill" : "bookmark")
                    .font(.caption)
            }
